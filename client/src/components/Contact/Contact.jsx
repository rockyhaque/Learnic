    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="grid lg:grid-cols-2 grid-cols-1">
          ...
          <div className="group w-full h-full">
            <div className="relative h-full">
              <img
                ...
                className="w-full h-full lg:rounded-l-2xl rounded-2xl bg-blend-multiply bg-sky-700"
              />
        ...
        <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
          <h2 className="text-sky-600 font-manrope text-4xl font-semibold leading-10 mb-11">
            Send Us A Message
          </h2>
          <input
            type="text"
          ...
          <input
            ...
            placeholder="Message"
          />
          <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-sky-800 bg-sky-600 shadow-sm">
            Send
          </button>
        </div>
      </div>
